...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_30__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodayForecast = __webpack_require__(33);

	var _TodayForecast2 = _interopRequireDefault(_TodayForecast);

	var _DaysForecast = __webpack_require__(35);

	var _DaysForecast2 = _interopRequireDefault(_DaysForecast);

	var _WeatherIcon = __webpack_require__(36);
	...
	var _temp = function () {
	  ...
	  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/ReactWeather.js');

	  __REACT_HOT_LOADER__.register(defaultProps, 'defaultProps', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/ReactWeather.js');

	  __REACT_HOT_LOADER__.register(ReactWeather, 'ReactWeather', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/ReactWeather.js');

	  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/ReactWeather.js');
	}();
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(OpenWeatherApi, [{
	    ...
	    value: function () {
	      function getForecast(args) {
	        ...
	        var endPointOneCall = this.baseApiUrl + '/onecall';
	        ...
	        var promise = _axios2['default'].all([_axios2['default'].get(endpointForecast, { params: params }), _axios2['default'].get(endPointOneCall, { params: params })]).then(_axios2['default'].spread(function (forecastReponse, oneCallResponse) {
	          var forecastData = forecastReponse.data;
	          var oneCallData = oneCallResponse.data;
	          if (forecastData && oneCallData) {
	            return _this._map(forecastData, oneCallData, params.lang);
	          }
	          return {};
	        }));
	        return promise;
	    ...
	    key: '_map',
	    value: function () {
	      function _map(forecastData, oneCallData, lang) {
	        ...
	        mapped.current = {
	          ...
	          date: _utils2['default'].formatDate(oneCallData.current.dt, lang)
	        };
	    ...
	    value: function () {
	      function _mapForecast(daysData, lang) {
	        ...
	        for (var i = 1; i < 5; i++) {
	          ...
	          dayMapped.date = _utils2['default'].formatDate(daysData[i].dt, lang); // Getting the date from the 1st data object (random)
	...
	var _temp = function () {
	  ...
	  __REACT_HOT_LOADER__.register(OpenWeatherApi, 'OpenWeatherApi', '/Users/matthewhonkanen/projects/react-open-weather/src/js/OpenWeatherApi.js');

	  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/matthewhonkanen/projects/react-open-weather/src/js/OpenWeatherApi.js');
	}();
	...
	module.exports = {
	  ...
	  getNextDays: function () {
	    function getNextDays(tomorrow) {
	      // Returns an array containing today's date plus the next 4 days dates in format yyyy-mm-dd
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = function () {
	  ...
	  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/TodayForecast.js');

	  __REACT_HOT_LOADER__.register(TodayForecast, 'TodayForecast', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/TodayForecast.js');

	  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/TodayForecast.js');
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = function () {
	  ...
	  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/DaysForecast.js');

	  __REACT_HOT_LOADER__.register(DaysForecast, 'DaysForecast', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/DaysForecast.js');

	  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/DaysForecast.js');
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = function () {
	  ...
	  __REACT_HOT_LOADER__.register(WeatherIcon, 'WeatherIcon', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/WeatherIcon.js');

	  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/matthewhonkanen/projects/react-open-weather/src/js/components/WeatherIcon.js');
	}();
